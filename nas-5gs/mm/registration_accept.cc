...
extern const element_meta reg_res, guti_5gs_mobile_id, plmn_list, ta_id_list,
    allowed_nssai, rejected_nssai, configured_nssai, nw_feat_sup, pdu_ses_status,
    pdu_ses_react_res, pdu_ses_react_res_err_c, ladn_inf, mico_ind, nw_slicing_ind, sal,
    t3512_gprs_timer_3, de_reg_timer_gprs_timer2, t3502_gprs_timer_2, emerg_num_list,
    emerg_num_list_7a, sor_trans_cont, eap_message, nssai_inclusion_mode,
    operator_defined_acd, nego_drx_param;
}
...
int mm::registration_accept(dissector d, context* ctx) {
    ...
    auto consumed = dissect_elem_lv(nullptr, &reg_res, d);
    d.offset += consumed;
    d.length -= consumed;

    /*77    5G-GUTI    5GS mobile identity 9.11.3.4    O    TLV-E    14 */
    // ELEM_OPT_TLV_E(0x77, NAS_5GS_PDU_TYPE_MM, DE_NAS_5GS_MM_5GS_MOBILE_ID, " -
    // 5G-GUTI");
    consumed = dissect_opt_elem_tlv_e(nullptr, &guti_5gs_mobile_id, d);
    d.offset += consumed;
    d.length -= consumed;

    /*4A    Equivalent PLMNs    PLMN list     9.11.3.33    O    TLV    5-47*/
    // ELEM_OPT_TLV(0x4a, GSM_A_PDU_TYPE_COMMON, DE_PLMN_LIST, " - Equivalent PLMNs");
    consumed = dissect_opt_elem_tlv(nullptr, &plmn_list, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &rejected_nssai, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &nw_feat_sup, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &pdu_ses_react_res, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv_e(nullptr, &pdu_ses_react_res_err_c, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &de_reg_timer_gprs_timer2, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &emerg_num_list, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &emerg_num_list_7a, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv_e(nullptr, &sor_trans_cont, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv_e(nullptr, &eap_message, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tv_short(nullptr, &nssai_inclusion_mode, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv_e(nullptr, &operator_defined_acd, d);
    d.offset += consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &nego_drx_param, d);
    d.offset += consumed;
    d.length -= consumed;
