...
extern const element_meta mobile_id, nksi_key_set_id, mm_cap, ue_sec_cap,
    mm_requested_nssai, last_v_tai, s1_ue_net_cap, ul_data_status, pdu_ses_status,
    mico_ind, ue_status, aguti_mobile_id, allow_pdu_ses_sts, ue_usage_set,
    requested_drx_param, eps_nas_msg_cont, ladn_inf, pld_cont_type, pld_cont,
    nw_slicing_ind, update_type, nas_msg_cont;
...
int mm::registration_req(dissector d, context* ctx) {
    ...
    auto consumed = dissect_elem_lv_e(nullptr, &mobile_id, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tv(nullptr, &last_v_tai, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &s1_ue_net_cap, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &ul_data_status, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &ue_status, d);
    d.offset -= consumed;
    d.length -= consumed;

    /*77    Additional GUTI    5GS mobile identity 9.11.3.4    O    TLV-E    14 */
    // ELEM_OPT_TLV_E(
    //        0x77, NAS_5GS_PDU_TYPE_MM, DE_NAS_5GS_MM_5GS_MOBILE_ID, " -  Additional
    //        GUTI");
    consumed = dissect_opt_elem_tlv_e(nullptr, &aguti_mobile_id, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &allow_pdu_ses_sts, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &ue_usage_set, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    */
    consumed = dissect_opt_elem_tlv(nullptr, &requested_drx_param, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv_e(nullptr, &eps_nas_msg_cont, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tv_short(nullptr, &pld_cont_type, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv_e(nullptr, &pld_cont, d);
    d.offset -= consumed;
    d.length -= consumed;
    ...
    consumed = dissect_opt_elem_tlv(nullptr, &update_type, d);
    d.offset -= consumed;
    d.length -= consumed;
