...
result_t de_registration_request(dissector d, context* ctx, void* ret);
result_t de_registration_accept(dissector d, context*ctx, void*ret);
result_t de_registration_complete(dissector d, context*ctx, void*ret);
result_t de_registration_reject(dissector d, context*ctx, void*ret);
result_t de_deregistration_request_ue_origin(dissector d, context*ctx, void*ret);
result_t de_deregistration_accept_ue_origin(dissector d, context*ctx, void*ret);
result_t de_deregistration_request_ue_terminate(dissector d, context*ctx, void*ret);
result_t de_deregistration_accept_ue_terminate(dissector d, context*ctx, void*ret);
result_t de_service_request(dissector d, context*ctx, void*ret);
result_t de_service_reject(dissector d, context*ctx, void*ret);
result_t de_service_accept(dissector d, context*ctx, void*ret);
result_t de_configuration_update_command(dissector d, context*ctx, void*ret);
result_t de_configuration_update_complete(dissector d, context*ctx, void*ret);
result_t de_authentication_request(dissector                 d,
                                   context*                  ctx,
                                   authentication_request_t* ret);
result_t de_authentication_response(dissector d, context*ctx, void*ret);
result_t de_authentication_reject(dissector d, context*ctx, void*ret);
result_t de_authentication_failure(dissector d, context*ctx, void*ret);
result_t de_authentication_result(dissector d, context*ctx, void*ret);
result_t de_identity_request(dissector d, context*ctx, void*ret);
result_t de_identity_response(dissector d, context*ctx, void*ret);
result_t de_security_mode_command(dissector d, context*ctx, void*ret);
result_t de_security_mode_complete(dissector d, context*ctx, void*ret);
result_t de_security_mode_reject(dissector d, context*ctx, void*ret);
result_t de_nmm_status(dissector d, context*ctx, void*ret);
result_t de_notification(dissector d, context*ctx, void*ret);
...
result_t de_dl_nas_transparent(dissector d, context*ctx, void*ret);
result_t de_pdu_session_establishment_request(dissector d, context*ctx, void*ret);
result_t de_pdu_session_establishment_accept(dissector d, context*ctx, void*ret);
result_t de_pdu_session_establishment_reject(dissector d, context*ctx, void*ret);
result_t de_pdu_session_authentication_command(dissector d, context*ctx, void*ret);
result_t de_pdu_session_authentication_complete(dissector d, context*ctx, void*ret);
result_t de_pdu_session_modification_request(dissector d, context*ctx, void*ret);
result_t de_pdu_session_modification_reject(dissector d, context*ctx, void*ret);
result_t de_pdu_session_modification_command(dissector d, context*ctx, void*ret);
result_t de_pdu_session_modification_complete(dissector d, context*ctx, void*ret);
result_t de_pdu_session_modification_command_reject(dissector d, context*ctx, void*ret);
result_t de_pdu_session_release_request(dissector d, context*ctx, void*ret);
result_t de_pdu_session_release_reject(dissector d, context*ctx, void*ret);
result_t de_pdu_session_release_command(dissector d, context*ctx, void*ret);
result_t de_pdu_session_release_complete(dissector d, context*ctx, void*ret);
result_t de_nsm_status(dissector d, context*ctx, void*ret);
...
result_t de_registration_reject(dissector d, context* ctx, void* ret);
result_t de_authentication_failure(dissector d, context* ctx, void* ret);
result_t de_deregistration_request_ue_orig(dissector d, context* ctx, void* ret);
result_t de_deregistration_accept_ue_orig(dissector d, context* ctx, void* ret);
result_t de_deregistration_request_ue_term(dissector d, context* ctx, void* ret);
result_t de_deregistration_accept_ue_term(dissector d, context* ctx, void* ret);
result_t de_service_request(dissector d, context* ctx, void* ret);
result_t de_service_reject(dissector d, context* ctx, void* ret);
result_t de_service_accept(dissector d, context* ctx, void* ret);
result_t de_configuration_update_command(dissector d, context* ctx, void* ret);
result_t de_configuration_update_complete(dissector d, context* ctx, void* ret);
result_t de_authentication_request(dissector d, context* ctx, void* ret);
result_t de_authentication_response(dissector d, context* ctx, void* ret);
result_t de_authentication_reject(dissector d, context* ctx, void* ret);
result_t de_authentication_failure(dissector d, context* ctx, void* ret);
result_t de_authentication_result(dissector d, context* ctx, void* ret);
...
IEI	IEI	Information Element	Type/Reference	Presence	Format	Length
	PTI	Procedure transaction identity	9.6	M	V	1
MANAGE UE POLICY COMMAND message identity	UE policy delivery service message type	D.6.1	M	V	1			UE policy section management list
UE policy section management list	D.6.2	M	LV-E	11-65533


Table D.5.2.1.1: MANAGE UE POLICY COMPLETE message content
IEI	Information Element	Type/Reference	Presence	Format	Length
	PTI	Procedure transaction identity	9.6	M	V	1
	MANAGE UE POLICY COMPLETE message identity	UE policy delivery service message type	D.6.1	M	V	1

Table D.5.3.1.1: MANAGE UE POLICY COMMAND REJECT message content
IEI	IEI	Information Element	Type/Reference	Presence	Format	Length
	PTI	Procedure transaction identity	9.6	M	V	1
MANAGE UE POLICY COMMAND REJECT message identity	UE policy delivery service message type	D.6.1.	M	V	1			UE policy section management result
UE policy section management result	D.6.3	M	LV-E	11-65533


Table D.5.4.1.1: UE STATE INDICATION message content
IEI	IEI	Information Element	Type/Reference	Presence	Format	Length
	PTI	Procedure transaction identity	9.6	M	V	1
UE STATE INDICATION message identity	UE policy delivery service message type	D.6.1	M	V	1			UPSI list
UPSI list	D.6.4	M	LV-E	9-65531			UE policy classmark	UE policy classmark	D.6.5
M	LV	2-4	41	41	UE OS Id	OS Id	D.6.6	O
TLV	18-242
