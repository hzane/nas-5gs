...
inline const uint32_t sep_dot            = 20u; // hex seperatored by .
inline const uint32_t sep_dash           = 21u; // hex speratored by -
inline const uint32_t sep_colon          = 22u; // hex seperatored by ,
inline const uint32_t sep_space          = 23u; // hex speratored by [space]
