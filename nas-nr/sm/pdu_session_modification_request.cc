...
int sm::dissect_pdu_session_modification_request(dissector d, context* ctx) {
    ...
    auto consumed = dissect_opt_tlv( &nrsm_capability, d, ctx);
    d.step(consumed);
    ...
    consumed = dissect_opt_tv( &integrity_protection_max_data_rate, d, ctx);
    d.step(consumed);
    ...
    consumed = dissect_opt_tlv_e( &requested_qos_rules, d, ctx);
    d.step(consumed);
    ...
    consumed = dissect_opt_tlv_e( &requested_qos_flow_desc, d, ctx);
    d.step(consumed);
