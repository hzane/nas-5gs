...
const tf_string tfs_epts1 = {
    "Ethernet PDN type in S1 mode supported","Ethernet PDN type in S1 mode not supported",
};

const field_meta hf_epts1 = {
    "Ethernet PDN type in S1 mode (IEPT-S1)", "nas.nr.sm.nw.feature.iept.s1",
    ft::ft_boolean, fd::base_dec, nullptr, &tfs_epts1, nullptr, 0,
};
