...
const tf_string tfs_cpoi={
    "PDU session can be used for control plane CIoT 5GS optimization only","reserved",
};

const field_meta hf_cpoi = {
    "Control plane only indication value (CPOI)", "nas.nr.sm.cpoi",
    ft::ft_boolean, fd::base_dec, nullptr, &tfs_cpoi, nullptr, 0x01u,
};
