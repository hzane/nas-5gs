...
inline const uint32_t ft_signed        = 0x80;
inline const uint32_t ft_unsigned      = 0x40;
inline const uint32_t protocol         = 18;
inline const uint32_t ft_boolean       = 17;
inline const uint32_t ft_struct        = 12;
inline const uint32_t ft_expert        = 11;
...
inline const uint32_t nt_bin           = 9;
inline const uint32_t nt_string        = 10;
inline const uint32_t nt_bit7          = 13;
inline const uint32_t nt_ipv4          = 14;
inline const uint32_t nt_ipv6          = 15;
inline const uint32_t nt_mac           = 17;
inline const uint32_t nt_ip64          = 18;
inline const uint32_t nt_timer_1       = 19;
inline const uint32_t nt_timer_2       = 20;
inline const uint32_t nt_timer_3       = 21;
inline const uint32_t nt_bcd           = 22;
inline const uint32_t nt_bstrn         = 23;
inline const uint32_t nt_char          = 24;
inline const uint32_t nt_imei          = 25;
inline const uint32_t nt_xlen          = 26;
inline const uint32_t nt_ambr          = 27;
inline const uint32_t nt_addr8         = 28;
inline const uint32_t nt_timezone      = 29;
inline const uint32_t nt_timezone_time = 30;
inline const uint32_t nt_nibble = 16;
